return {
	...
	PlaceObj('ModItemCode', {
		'name', "AIPOLICYPOS_EncircleEnemy",
		'CodeFileName', "Code/AIPOLICYPOS_EncircleEnemy.lua",
	}),
	PlaceObj('ModItemCode', {
	...
	PlaceObj('ModItemCode', {
		'name', "AIPOLICYPOS_ThreatExposure",
		'CodeFileName', "Code/AIPOLICYPOS_ThreatExposure.lua",
	}),
	PlaceObj('ModItemCode', {
		'name', "AIPOLICYPOS_CustomWeaponRange",
		'CodeFileName', "Code/AIPOLICYPOS_CustomWeaponRange.lua",
	}),
	PlaceObj('ModItemCode', {
	...
	PlaceObj('ModItemCode', {
		'name', "AIPOLICYPOS_StayNearAllies",
		'CodeFileName', "Code/AIPOLICYPOS_StayNearAllies.lua",
	}),
	PlaceObj('ModItemCode', {
	...
	PlaceObj('ModItemCode', {
		'name', "AIPOLICYPOS_AvoidDeathSpots",
	...
	PlaceObj('ModItemCode', {
		'name', "AIPOLICYTARG_HasStatusEffect",
		'CodeFileName', "Code/AIPOLICYTARG_HasStatusEffect.lua",
	}),
	PlaceObj('ModItemCode', {
	...
	PlaceObj('ModItemCode', {
		'name', "SOURCE_AIPolicyProximity",
		'CodeFileName', "Code/SOURCE_AIPolicyProximity.lua",
	}),
	PlaceObj('ModItemCode', {
		'name', "SOURCE_AIPolicyHighGround",
	...
	PlaceObj('ModItemCode', {
		'name', "SOURCE_AIPrecalcConeTargetZones",
		'CodeFileName', "Code/SOURCE_AIPrecalcConeTargetZones.lua",
	}),
	PlaceObj('ModItemCode', {
	...
	PlaceObj('ModItemAIArchetype', {
		Behaviors = {
			PlaceObj('StandardAI', {
				...
				'TakeCoverChance', 0,
				'override_attack_id', "MGBurstFire",
				'override_cost_id', "MGBurstFire",
			}),
			PlaceObj('HoldPositionAI', {
				'Weight', 200,
				'Comment', "In Setup",
	...
	PlaceObj('ModItemAIArchetype', {
		Behaviors = {
			PlaceObj('StandardAI', {
				'Comment', "fire",
				'Score', function (self, unit, proto_context, debug_data)
					return RATOAI_GunnerAttackScore(self, unit, proto_context, debug_data)
					--return getStandardBehaviorScore_HeavyGunner(self, unit, proto_context, debug_data)
				end,
				'EndTurnPolicies', {
					PlaceObj('AIPolicyThreatExposure', {
			...
			PlaceObj('StandardAI', {
				...
				'Fallback', false,
				'Score', function (self, unit, proto_context, debug_data)
					return RATOAI_GunnerMGScore(self, unit, proto_context, debug_data)
				end,
				'OptLocWeight', 150,
				'EndTurnPolicies', {
					PlaceObj('AIPolicyThreatExposure', {
	...
	PlaceObj('ModItemAIArchetype', {
		...
		TargetingPolicies = {
			...
			PlaceObj('AITargetingHasStatusEffect', {
				'Weight', 50,
				'StatusID', "Flanked",
			}),
		},
	...
	PlaceObj('ModItemUnitDataCompositeDef', {
		...
		'Name', T(195403006020, --[[ModItemUnitDataCompositeDef AdonisFlanker_copy Name]] "Commando"),
		'Randomization', true,
		'Affiliation', "Adonis",
		'StartingLevel', 3,
		'neutral_retaliate', true,
	...
	PlaceObj('ModItemUnitDataCompositeDef', {
		...
		'Name', T(384992128748, --[[ModItemUnitDataCompositeDef AdonisAssault_copy Name]] "Guard"),
		'Randomization', true,
		'Affiliation', "Adonis",
		'StartingLevel', 6,
		'neutral_retaliate', true,
